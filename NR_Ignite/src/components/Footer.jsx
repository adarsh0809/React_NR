    ...
    <footer className="bg-gray-700 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <h2 className='text-2xl font-bold '>Food<span className='text-[#F83002]'> Suggy</span></h2>
            <p className="text-sm mt-2 opacity-75">© 2024 Food Suggy. All rights reserved.</p>
          </div>

          <div className="flex space-x-6">
            <a href="https://facebook.com" className="hover:text-gray-400 transition-colors duration-200" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-gray-400 transition-colors duration-200" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-gray-400 transition-colors duration-200" aria-label="LinkedIn">
