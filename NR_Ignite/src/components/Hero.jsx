  ...
  return (
    <>
      ...
      <div className="flex flex-col  items-center justify-center ">
        ...
        <div className="flex">
          <input className="w-[500px] h-[30px]  border-[3px] rounded-lg " value = {searchKey} onChange={(e) => setsearchKey(e.target.value)}></input>
          <button onClick={()=>{
            const searchData = restData.filter((res)=> res.info.name.toLowerCase().includes(searchKey.toLowerCase()));
            setSData(searchData);
